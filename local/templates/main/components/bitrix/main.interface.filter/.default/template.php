...
<form name="filter_<?=$arParams["GRID_ID"]?>" method="GET">
<?
...
endforeach;
?>
	<input type="hidden" name="TAB" value="<?=$arParams["GRID_ID"]?>">
...
<?endforeach?>
			...
			<div class="bx-filter-buttons">
				<input type="submit" class="btn-bordo" name="filter" value="<?echo GetMessage("interface_grid_find")?>" title="<?echo GetMessage("interface_grid_find_title")?>">
				<input type="button"  class="btn-bordo" name="" value="<?echo GetMessage("interface_grid_flt_cancel")?>" title="<?echo GetMessage("interface_grid_flt_cancel_title")?>" onclick="bxGrid_<?=$arParams["GRID_ID"]?>.ClearFilter(this.form)">
